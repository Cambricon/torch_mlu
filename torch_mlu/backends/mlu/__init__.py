...
__all__ = ["matmul", "custom", "CnnlMatmulTF32Controller", "MLUCustomTF32Controller",
  ...
  "SDPBackend", "SDPAParams", "enable_flash_sdp", "flash_sdp_enabled", "enable_mem_efficient_sdp",
  "mem_efficient_sdp_enabled", "math_sdp_enabled", "enable_math_sdp", "can_use_flash_attention",
  "can_use_efficient_attention","sdp_kernel", "is_built"]
...
from torch_mlu._MLUC import _SDPAParams as SDPAParams, _SDPBackend as SDPBackend
...
def sdp_kernel(
    ...
    warnings.warn(
        (
            "torch_mlu.backends.mlu.sdp_kernel() "
