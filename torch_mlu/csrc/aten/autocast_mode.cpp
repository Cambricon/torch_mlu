...
TORCH_LIBRARY_IMPL(aten, AutocastPrivateUse1, m) {
  ...
  // KERNEL_PRIVATEUSEONE2(norm, ScalarOpt_dtype, fp32_set_opt_dtype)
  // KERNEL_PRIVATEUSEONE2(norm, ScalarOpt_dim_dtype, fp32_set_opt_dtype)
  // KERNEL_PRIVATEUSEONE2(norm, names_ScalarOpt_dim_dtype, fp32_set_opt_dtype)
  ...
  KERNEL_DIFFERENT_REDISPATCH_SIGNATURE_PRIVATEUSEONE(
      ...
      at::Tensor(
          const at::Tensor&, const c10::optional<at::Scalar>&, at::ScalarType),
      fp32_append_dtype)
  KERNEL_DIFFERENT_REDISPATCH_SIGNATURE_PRIVATEUSEONE(
      ADD_NS(norm),
      "norm.ScalarOpt_dim",
