...
std::tuple<at::Tensor, at::Tensor, at::Tensor> cnnl__flash_attention_backward(
  ...
  std::tie(dq, dk, dv, grad_softmax) = mha_varlen_bwd_internal(
      contiguous_grad_out,
      query,
      key,
      value,
...
cnnl__efficient_attention_forward(
  ...
  auto [log_sumexp, seed, offset] = mem_eff_fwd_internal(
      query_reshaped,
      key_reshaped,
      value_reshaped,
      bias_c,
...
cnnl__efficient_attention_backward(
  ...
  std::tie(grad_q, grad_k, grad_v) = mem_eff_bwd_internal(
      grad_out_reshaped,
      query_reshaped,
      key_reshaped,
      value_reshaped,
