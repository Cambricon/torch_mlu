...
using at::native::log10_stub_DECLARE_DISPATCH_type;
using at::native::log1p_stub;
using at::native::log1p_stub_DECLARE_DISPATCH_type;
using at::native::log2_stub;
using at::native::log2_stub_DECLARE_DISPATCH_type;
using at::native::log_stub;
using at::native::log_stub_DECLARE_DISPATCH_type;
