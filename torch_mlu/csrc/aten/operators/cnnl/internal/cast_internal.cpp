...
static const std::map<pair, cnnlCastDataType_t> cast_map = {
    ...
    // Only support INT16 to INT64, INT32, Float, Half
    ...
    {pair{CNNL_DTYPE_INT16, CNNL_DTYPE_INT64}, CNNL_CAST_INT16_TO_INT64},
    ...
    // Only support BOOL to INT64, INT32, Float, Half, Bfloat16
    ...
    {pair{CNNL_DTYPE_BOOL, CNNL_DTYPE_INT64}, CNNL_CAST_BOOL_TO_INT64},
    {pair{CNNL_DTYPE_BOOL, CNNL_DTYPE_BFLOAT16}, CNNL_CAST_BOOL_TO_BFLOAT16},
    {pair{CNNL_DTYPE_INT64, CNNL_DTYPE_BOOL}, CNNL_CAST_INT64_TO_BOOL},
    {pair{CNNL_DTYPE_INT64, CNNL_DTYPE_INT32}, CNNL_CAST_INT64_TO_INT32},
    {pair{CNNL_DTYPE_INT64, CNNL_DTYPE_INT16}, CNNL_CAST_INT64_TO_INT16},
    ...
    // cast to FLOAT8E4M3FN and FLOAT8E5M2
    {pair{CNNL_DTYPE_FLOAT, CNNL_DTYPE_FLOAT8_E4M3FN},
     CNNL_CAST_FLOAT_TO_FLOAT8_E4M3FN},
    {pair{CNNL_DTYPE_FLOAT, CNNL_DTYPE_FLOAT8_E5M2},
     CNNL_CAST_FLOAT_TO_FLOAT8_E5M2},
    {pair{CNNL_DTYPE_HALF, CNNL_DTYPE_FLOAT8_E4M3FN},
     CNNL_CAST_HALF_TO_FLOAT8_E4M3FN},
    {pair{CNNL_DTYPE_HALF, CNNL_DTYPE_FLOAT8_E5M2},
     CNNL_CAST_HALF_TO_FLOAT8_E5M2},
    {pair{CNNL_DTYPE_INT32, CNNL_DTYPE_FLOAT8_E4M3FN},
     CNNL_CAST_INT32_TO_FLOAT8_E4M3FN},
    {pair{CNNL_DTYPE_INT32, CNNL_DTYPE_FLOAT8_E5M2},
     CNNL_CAST_INT32_TO_FLOAT8_E5M2},
    {pair{CNNL_DTYPE_INT16, CNNL_DTYPE_FLOAT8_E4M3FN},
     CNNL_CAST_INT16_TO_FLOAT8_E4M3FN},
    {pair{CNNL_DTYPE_INT16, CNNL_DTYPE_FLOAT8_E5M2},
     CNNL_CAST_INT16_TO_FLOAT8_E5M2},
    {pair{CNNL_DTYPE_INT64, CNNL_DTYPE_FLOAT8_E4M3FN},
     CNNL_CAST_INT64_TO_FLOAT8_E4M3FN},
    {pair{CNNL_DTYPE_INT64, CNNL_DTYPE_FLOAT8_E5M2},
     CNNL_CAST_INT64_TO_FLOAT8_E5M2},
    {pair{CNNL_DTYPE_BFLOAT16, CNNL_DTYPE_FLOAT8_E4M3FN},
     CNNL_CAST_BFLOAT16_TO_FLOAT8_E4M3FN},
    {pair{CNNL_DTYPE_BFLOAT16, CNNL_DTYPE_FLOAT8_E5M2},
     CNNL_CAST_BFLOAT16_TO_FLOAT8_E5M2},
    // cast from FLOAT8E4M3FN and FLOAT8E5M2
    {pair{CNNL_DTYPE_FLOAT8_E4M3FN, CNNL_DTYPE_HALF},
     CNNL_CAST_FLOAT8_E4M3FN_TO_HALF},
    {pair{CNNL_DTYPE_FLOAT8_E4M3FN, CNNL_DTYPE_FLOAT},
     CNNL_CAST_FLOAT8_E4M3FN_TO_FLOAT},
    {pair{CNNL_DTYPE_FLOAT8_E4M3FN, CNNL_DTYPE_BFLOAT16},
     CNNL_CAST_FLOAT8_E4M3FN_TO_BFLOAT16},
    {pair{CNNL_DTYPE_FLOAT8_E4M3FN, CNNL_DTYPE_INT32},
     CNNL_CAST_FLOAT8_E4M3FN_TO_INT32},
    {pair{CNNL_DTYPE_FLOAT8_E4M3FN, CNNL_DTYPE_INT64},
     CNNL_CAST_FLOAT8_E4M3FN_TO_INT64},
    {pair{CNNL_DTYPE_FLOAT8_E4M3FN, CNNL_DTYPE_INT16},
     CNNL_CAST_FLOAT8_E4M3FN_TO_INT16},
    {pair{CNNL_DTYPE_FLOAT8_E5M2, CNNL_DTYPE_HALF},
     CNNL_CAST_FLOAT8_E5M2_TO_HALF},
    {pair{CNNL_DTYPE_FLOAT8_E5M2, CNNL_DTYPE_FLOAT},
     CNNL_CAST_FLOAT8_E5M2_TO_FLOAT},
    {pair{CNNL_DTYPE_FLOAT8_E5M2, CNNL_DTYPE_BFLOAT16},
     CNNL_CAST_FLOAT8_E5M2_TO_BFLOAT16},
    {pair{CNNL_DTYPE_FLOAT8_E5M2, CNNL_DTYPE_INT32},
     CNNL_CAST_FLOAT8_E5M2_TO_INT32},
    {pair{CNNL_DTYPE_FLOAT8_E5M2, CNNL_DTYPE_INT64},
     CNNL_CAST_FLOAT8_E5M2_TO_INT64},
    {pair{CNNL_DTYPE_FLOAT8_E5M2, CNNL_DTYPE_INT16},
     CNNL_CAST_FLOAT8_E5M2_TO_INT16}};
