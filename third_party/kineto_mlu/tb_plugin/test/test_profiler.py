...
class TestProfiler(unittest.TestCase):
    ...
    def test_all_categories(self):
        json_content = """
            ...
            {
                "ph": "X", "cat": "gpu_memcpy",
                "name": "Memcpy HtoD", "pid": 0, "tid": "1",
                "ts": 405, "dur": 10,
                "args": {"stream": 7, "correlation": 334, "external id": 4}
            },
            {
                "ph": "X", "cat": "privateuse1_runtime",
                "name": "cnrtMemcpyAsync", "pid": 13721, "tid": "456",
                "ts": 360, "dur": 20,
                "args": {"correlation": 334, "external id": 4}
            },
            {
                "ph": "X", "cat": "gpu_memset",
                "name": "Memset", "pid": 0, "tid": "1",
                "ts": 420, "dur": 5,
                "args": {"stream": 7, "correlation": 40344, "external id": 4}
            },
            {
                "ph": "X", "cat": "privateuse1_runtime",
                "name": "cnrtMemsetAsync", "pid": 13721, "tid": "456",
                "ts": 390, "dur": 10,
                "args": {"correlation": 40344, "external id": 4}
            },
            {
                "ph": "X", "cat": "kernel",
                "name": "void MLUUnion1NlllossForwardVaa<float, (deviceMode_t)1>(float*, float*, float*, float*, float*, int*, int, unsigned int, unsigned int, unsigned int, bool)", "pid": 0, "tid": "1",
                "ts": 430, "dur": 15,
                "args": {"correlation": 40348, "external id": 4, "device": 0}
            },
            {
                "ph": "X", "cat": "privateuse1_runtime",
                "name": "cnInvokeKernel", "pid": 13721, "tid": "456",
                "ts": 405, "dur": 5,
        ...
        self.assertEqual(profile.kernel_list_groupby_name_op[0].name,
                         'void MLUUnion1NlllossForwardVaa<float, (deviceMode_t)1>(float*, float*, float*, float*, float*, int*, int, unsigned int, unsigned int, unsigned int, bool)')
        self.assertEqual(
    ...
    # Test using external_id to build relationship between cpu_op and Runtime.
    ...
    def test_remove_dup_nodes(self):
        json_content = """[
            ...
            {
                "ph": "X", "cat": "kernel",
                "name": "void gemmSN_TN_kernel_64addr", "pid": 0, "tid": "1",
                "ts": 220, "dur": 8,
    ...
    @pytest.mark.skip(reason="One cnInvokeKernel only can trigger one kernel, skip this testcase.")
    ...
    def test_multiple_profilersteps_no_overlap(self):
        json_content = """
            ...
            {
                "ph": "X", "cat": "privateuse1_runtime",
                "name": "cnrtMemcpyAsync", "pid": 13721, "tid": "123",
                "ts": 250, "dur": 5,
            ...
            {
                "ph": "X", "cat": "privateuse1_runtime",
                "name": "cnInvokeKernel", "pid": 13721, "tid": "123",
                "ts": 400, "dur": 5,
                "args": {"correlation": 40348, "external id": 4}
            }]
        """
    ...
    # Test MLU utilization, est. SM efficiency, and occupancy.
    def test_mlu_utilization(self):
        json_content = """
            ...
            {
                "ph": "X", "cat": "kernel",
                "name": "void MLUUnion1NlllossForwardVaa<float, (deviceMode_t)1>(float*, float*, float*, float*, float*, int*, int, unsigned int, unsigned int, unsigned int, bool)", "pid": 1, "tid": "1",
                "ts": 130, "dur": 10,
        ...
        for mlu_id in profile.mlu_metrics_parser.mlu_ids:
            ...
            for b in buckets:
                ...
                self.assertAlmostEqual(b[1], mlu_util_expected[mlu_util_id][1])
                mlu_util_id += 1
            self.assertEqual(mlu_util_id, len(mlu_util_expected))
        ...
        for agg_by_op in profile.kernel_list_groupby_name_op:
            if agg_by_op.name == 'void gemmSN_TN_kernel_64addr' and agg_by_op.op_name == 'aten::mat_mul':
                ...
                count += 1
            if agg_by_op.name == 'void MLUUnion1NlllossForwardVaa<float, (deviceMode_t)1>(float*, float*, float*, float*, float*, int*, int, unsigned int, unsigned int, unsigned int, bool)' and \
        ...
        for _id, (name, row) in enumerate(profile.kernel_stat.iterrows()):
            ...
            if name == 'void gemmSN_TN_kernel_64addr':
                ...
                count += 1
            if name == 'void MLUUnion1NlllossForwardVaa<float, (deviceMode_t)1>(float*, float*, float*, float*, float*, int*, int, unsigned int, unsigned int, unsigned int, bool)':
                self.assertAlmostEqual(
    ...
    # Test MLU utilization 3 metrics works fine if kernel out of ProfilerStep.
    def test_mlu_utilization_kernel_out_of_step(self):
        json_content = """
            [{
                "ph": "X", "cat": "cpu_op",
                "name": "aten::mat_mul", "pid": 13721, "tid": "456",
        ...
        count = 0
        for agg_by_op in profile.kernel_list_groupby_name_op:
            if agg_by_op.name == 'void MLUUnion1NlllossForwardVaa<float, (deviceMode_t)1>(float*, float*, float*, float*, float*, int*, int, unsigned int, unsigned int, unsigned int, bool)' \
    ...
    def test_dump_mlu_metrics(self):
        profile = RunProfile('test_dump_mlu_metrics', None)
        # Faked data for easy to see in UI. Real data values are 1/100 of these.
        mlu_util_buckets = [[(1621401187223005, 0.0), (1621401187224005, 0.0),
        ...
        trace_json_expected_path = os.path.join(basedir, 'mlu_metrics_expected.json')
        ...
        data_with_mlu_metrics_json = json.loads(
            data_with_mlu_metrics_flat.decode('utf8'))
        data_expected_json = json.loads(data_expected.decode('utf8'))
        data_with_mlu_metrics_str = json.dumps(
            data_with_mlu_metrics_json, sort_keys=True)
        data_expected_str = json.dumps(data_expected_json, sort_keys=True)

        self.assertEqual(data_with_mlu_metrics_str, data_expected_str)

        try:
            _ = json.loads(data_with_mlu_metrics_flat.decode('utf8'))
        except Exception:
            self.assertTrue(
                False, 'The string fails to be parsed by json after appending mlu metrics.')
    ...
    def test_memory_view(self):
        json_content = """[
            ...
            },
            {
                ...
                "ts": 210,
                "args": {
                "Device Type": 20, "Device Id": 0, "Addr": 210, "Bytes": 4
                }
            },
            {
                "ph": "i", "s": "t", "name": "[memory]",
                ...
                "ts": 265,
                "args": {
                "Device Type": 20, "Device Id": 0, "Addr": 265, "Bytes": 4
                }
            },
            {
                "ph": "i", "s": "t", "name": "[memory]",
                ...
                "ts": 300,
                "args": {
                "Device Type": 20, "Device Id": 0, "Addr": 300, "Bytes": 4
                }
            },
            {
                "ph": "i", "s": "t", "name": "[memory]",
                ...
                "ts": 350,
                "args": {
                    "Device Type": 20, "Device Id": 0, "Addr": 350, "Bytes": 10
                }
            },
            {
                "ph": "i", "s": "t", "name": "[memory]",
...

            {
                ...
                "ts": 515,
                "args": {
                    "Device Type": 20, "Device Id": 0, "Addr": 515, "Bytes": 100
                }
            },
            {
                "ph": "i", "s": "t", "name": "[memory]",
                ...
                "ts": 520,
                "args": {
                    "Device Type": 20, "Device Id": 0, "Addr": 520, "Bytes": 100
                }
            },
            {
                "ph": "i", "s": "t", "name": "[memory]",
            ...
            },
            {
                ...
                "ts": 690,
                "args": {
                    "Device Type": 20, "Device Id": 0, "Addr": 690, "Bytes": 100
                }
            },
            {
                "ph": "i", "s": "t", "name": "[memory]",
                ...
                "ts": 701,
                "args": {
                    "Device Type": 20, "Device Id": 0, "Addr": 701, "Bytes": 100
                }
            },
            {
                "ph": "i", "s": "t", "name": "[memory]",
...

            {
                ...
                "ts": 708,
                "args": {
                    "Device Type": 20, "Device Id": 0, "Addr": 708, "Bytes": 100
                }
            },
            {
                "ph": "i", "s": "t", "name": "[memory]",
            ...
            },
            {
                ...
                "ts": 715,
                "args": {
                    "Device Type": 20, "Device Id": 0, "Addr": 715, "Bytes": 50
                }
            },
            {
                "ph": "i", "s": "t", "name": "[memory]",
            ...
            },
            {
                ...
                "ts": 725,
                "args": {
                    "Device Type": 20, "Device Id": 0, "Addr": 725, "Bytes": 50
                }
            },
            {
                "ph": "i", "s": "t", "name": "[memory]",
            ...
            },
            {
                ...
                "ts": 747,
                "args": {
                    "Device Type": 20, "Device Id": 0, "Addr": 747, "Bytes": 20
                }
            },
            {
                "ph": "i", "s": "t", "name": "[memory]",
            ...
            },
            {
                ...
                "ts": 760,
                "args": {
                    "Device Type": 20, "Device Id": 0, "Addr": 760, "Bytes": 30
                }
            },
            {
                "ph": "i", "s": "t", "name": "[memory]",
            ...
            },
            {
                ...
                "ts": 795,
                "args": {
                    "Device Type": 20, "Device Id": 0, "Addr": 795, "Bytes": 10
                }
            },
            {
                "ph": "i", "s": "t", "name": "[memory]",
        ...
        self.assertIn('MLU0', memory_stats)
        ...
        validate_data = [
            ...
            (memory_stats['MLU0'], mlu_expected_data)
        ]
    ...
    def test_group_by_kernel_columns(self):
        ...
        for agg_kernel in profile.kernel_list_groupby_name_op:
            ...
            self.assertEqual(str(agg_kernel.dim), expected_agg_kernel['dim'])
            self.assertEqual(str(agg_kernel.kernel_type), expected_agg_kernel['kernel_type'])
    ...
    def test_group_by_kernel_columns_invalid_input(self):
        ...
        for agg_kernel in profile.kernel_list_groupby_name_op:
            ...
            self.assertEqual(agg_kernel.name, expected_agg_kernel['name'])
            self.assertEqual(agg_kernel.op_name, expected_agg_kernel['op_name'])
            self.assertEqual(agg_kernel.dim, expected_agg_kernel['dim'])
            self.assertEqual(agg_kernel.kernel_type, expected_agg_kernel['kernel_type'])
            self.assertEqual(agg_kernel.calls, expected_agg_kernel['calls'])
            self.assertEqual(agg_kernel.total_duration, expected_agg_kernel['total_duration'])
            self.assertAlmostEqual(agg_kernel.avg_duration, expected_agg_kernel['avg_duration'])
            self.assertEqual(agg_kernel.min_duration, expected_agg_kernel['min_duration'])
    ...
    @pytest.mark.skip(reason="MLU don't use tensor core, skip this testcase.")
...
class TestDistributed(unittest.TestCase):
    ...
    def test_distributed_cncl(self):
        json_content0 = """[
            {
            "ph": "X", "cat": "user_annotation",
            "name": "cncl:broadcast", "pid": 23803, "tid": "23803",
            "ts": 0, "dur": 75,
            "args": {"External id": 146, "Input Dims": [[53120]], "Input type": ["float"]}
            },
            {
            "ph": "X", "cat": "gpu_memcpy",
            "name": "Memcpy PtoP", "pid": 0, "tid": "stream 16",
            "ts": 16, "dur": 16,
            ...
            {
            "ph": "X", "cat": "kernel",
            "name": "void at::native::vectorized_elementwise_kernel", "pid": 0, "tid": "1",
            "ts": 130, "dur": 161,
            "args": {"device": 0, "correlation": 99765, "external id": 24504}
            },
            {
            "ph": "X", "cat": "user_annotation",
            "name": "cncl:all_reduce", "pid": 23803, "tid": "25166",
            "ts": 160, "dur": 75,
        ...
        loader = RunLoader('test_cncl', '', None)
        ...
        self.assertEqual(dist_profile.comm_ops['data']['worker0']['rows'],
                         [['cncl:broadcast', 1, 212480, 212480, 75, 75, 36, 36],
                          ['cncl:all_reduce', 1, 8196000, 8196000, 1558, 1558, 1133, 1133]])
        self.assertEqual(dist_profile.comm_ops['data']['worker1']['rows'],
                         [['cncl:broadcast', 1, 212480, 212480, 39, 39, 36, 36],
                          ['cncl:all_reduce', 1, 8196000, 8196000, 1133, 1133, 1133, 1133]])

    @pytest.mark.skip(reason="skip gloo")
    def test_distributed_gloo_mlu(self):
        json_content0 = """[
            {
            "ph": "X", "cat": "cpu_op",
        ...
        loader = RunLoader('test_gloo_mlu', '', None)
        dist_profile = loader._process_distributed_profiles([dist_data0, dist_data1], 0)
...
class TestMemoryCurve(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.event_data_mlu = [
            [2, 20, 0, 11, 400, 400, 512],         # alloc 11
            [22, 20, 0, 11, -400, 0, 512],         # free  11
            [105, 20, 0, 12, 5000, 5000, 10240],   # alloc 12
            [106, 20, 0, 13, 3000, 8000, 10240],   # alloc 13
            [205, 20, 0, 12, -5000, 3000, 10240],  # free  12
            [401, 20, 0, 14, 1024, 4024, 10240],   # alloc 14
            [499, 20, 0, 15, 4, 4028, 10240],      # alloc 15
            [501, 20, 0, 13, -3000, 1028, 10240],  # free  13
            [502, 20, 0, 15, -4, 1024, 10240],     # free  15
            [906, 20, 0, 14, -1024, 0, 10240],     # free  14
        ]

        self.all_events = sorted(self.event_data_cpu + self.event_data_mlu, key=lambda e: e[0])
    ...
    def test_memory_curve_no_step_plot(self):
        ...
        self.assertEqual(len(self.event_data_mlu), len(curves['MLU0']))
        for i in range(len(self.event_data_mlu)):
            self.assertEqual(self.event_data_mlu[i][0] - start_ts,  curves['MLU0'][i][0])
            self.assertEqual(self.event_data_mlu[i][-2], curves['MLU0'][i][1])
            self.assertEqual(self.event_data_mlu[i][-1], curves['MLU0'][i][2])
    ...
    def test_memory_curve_step_plot(self):
        ...
        self.assertEqual(2 * len(self.event_data_mlu) - 1, len(curves['MLU0']))
        for i in range(len(self.event_data_mlu)):
            if i % 2 == 0:  # original values
                self.assertEqual(self.event_data_mlu[i//2][0] - start_ts,  curves['MLU0'][i][0])
                self.assertEqual(self.event_data_mlu[i//2][-2], curves['MLU0'][i][1])
                self.assertEqual(self.event_data_mlu[i//2][-1], curves['MLU0'][i][2])
            else:  # interpolated values
                self.assertEqual(self.event_data_mlu[i//2+1][0] - start_ts,  curves['MLU0'][i][0])
                self.assertEqual(self.event_data_mlu[i//2][-2], curves['MLU0'][i][1])
                self.assertEqual(self.event_data_mlu[i//2][-1], curves['MLU0'][i][2])
