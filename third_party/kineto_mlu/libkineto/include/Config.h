...
const std::set<libkineto::ActivityType> mluTypes = {
    libkineto::ActivityType::MLU_MEMCPY,
    libkineto::ActivityType::MLU_MEMSET,
    libkineto::ActivityType::MLU_CONCURRENT_KERNEL,
    libkineto::ActivityType::MLU_RUNTIME,
    libkineto::ActivityType::MLU_USER_ANNOTATION,
};
...
class Config : public AbstractConfig {
 public:
  ...
  int maxEventProfilersPerMlu() const {
    return eventProfilerMaxInstancesPerMlu_;
  }
  ...
  void setSelectedActivityTypes(const std::set<ActivityType>& types) {
    ...
    // Append MLU activityTypes
    selectedActivityTypes_.insert(mluTypes.begin(), mluTypes.end());
  }
  ...
  int activitiesMaxMluBufferSize() const {
    return activitiesMaxMluBufferSize_;
  }
 ...
 private:
  ...
  int eventProfilerMaxInstancesPerMlu_;
  ...
  int activitiesMaxMluBufferSize_;
  ...
  // Only profile nets with at least this many MLU operators
  int activitiesExternalAPIMluOpCountThreshold_;
