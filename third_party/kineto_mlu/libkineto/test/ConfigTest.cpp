...
TEST(ParseTest, ActivityTypes) {
  ...
  // MLU don't use defaultActivityTypes(), so it's same as GPU.
  EXPECT_EQ(cfg.selectedActivityTypes(),
  ...
  Config cfg2;
  // Using setSelectedActivityTypes() to set mlu activityTypes.
  cfg2.setSelectedActivityTypes({});
  EXPECT_EQ(cfg2.selectedActivityTypes(),
    std::set<ActivityType>({ActivityType::MLU_MEMCPY,
                            ActivityType::MLU_MEMSET,
                            ActivityType::MLU_RUNTIME,
                            ActivityType::MLU_CONCURRENT_KERNEL}));

  cfg2.setSelectedActivityTypes({ActivityType::CPU_OP, ActivityType::USER_ANNOTATION});
  EXPECT_EQ(cfg2.selectedActivityTypes(),
    std::set<ActivityType>({ActivityType::CPU_OP,
                            ActivityType::USER_ANNOTATION,
                            ActivityType::MLU_MEMCPY,
                            ActivityType::MLU_MEMSET,
                            ActivityType::MLU_RUNTIME,
                            ActivityType::MLU_CONCURRENT_KERNEL}));
}
