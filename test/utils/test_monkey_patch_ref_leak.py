...
exclude_other_list = [
    "torch._C",
    "torch.types.Device",
    "torch.cuda.memory.Device",
    "torch.cuda._device_t",
    "torch.mtia.Device",
    "torch.xpu.memory.Device",
    ...
    "torch.distributed.tensor.init_device_mesh",
    "torch.distributed._composable.fsdp._fsdp_init.init_device_mesh",
    "torch.testing._creation.make_tensor",
    ...
    "torch.nn.parallel.parallel_apply.autocast",
    "torch.nn.parallel.comm.nccl",
]
