...
class TestOps(TestCase):
    ...
    def test_close_view_chain(self):
        # After view chain closed, there will no any view chain info print.
        os.environ["DISABLE_VIEWCHAIN_FUNC"] = "1"
        os.environ["TORCH_MIN_CNLOG_LEVEL"] = "INFO"
        os.environ["ENABLE_PRINT_VIEW_CHAIN"] = "ON"
        ...
        self.assertTensorsEqual(output_cpu, output_mlu, 0, use_MSE=True)
