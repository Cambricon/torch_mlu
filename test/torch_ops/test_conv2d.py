...
# Now CATCH using cpu float conv result to diff2 with mlu bfloat16 / half conv result.
# For MLU bfloat16 conv test, catch using different threshold value to do this check.
...
# fixed threshold 0.003. Now CATCH using 0.004 to avoid this failed.
