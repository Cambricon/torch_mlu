...
class TestNegOps(TestCase):
    ...
    @testinfo()
    def test_neg(self):
        shape_list = [(5, 10, 2, 2), (2, 3, 4), (2, 2, 2, 1, 1, 3)]
        dtype_list = [torch.float, torch.half, torch.double, torch.long, torch.int]
    ...
    def test_neg_permute(self):
        shape_list = [(5, 10, 2, 2, 4), (10, 3, 3, 3), (2, 3, 4), (2, 2, 2, 1, 1, 3)]
