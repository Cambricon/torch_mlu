...
PYTORCH_VERSION="release/2.4" # set to native release version(eg: 2.1.0, 2.2.0) or branch(eg: release/2.1, release/2.2) in catch develop branch
CATCH_BRANCH='r2.4_develop'
VISION_VERSION='release/0.19'  # set to native release version(eg: 1.6.0) in catch develop branch
AUDIO_VERSION='release/2.4'  # set to native release version(eg: 2.1.0) in catch develop branch
