...
PYTORCH_VERSION="2.4.1" # set to native release version(eg: 2.1.0, 2.2.0) or branch(eg: release/2.1, release/2.2) in torch_mlu develop branch
TORCH_MLU_BRANCH='r2.4_develop'
TORCHAUDIO_MLU_BRANCH='r2.4_develop'
VISION_VERSION='0.19.1'  # set to native release version(eg: 1.6.0) in torch_mlu develop branch
AUDIO_VERSION='2.4.1'  # set to native release version(eg: 2.1.0) in torch_mlu develop branch
