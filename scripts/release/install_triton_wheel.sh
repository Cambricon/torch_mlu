...
if [[ ${GENESIS_TAG} == "release" ]]; then
    ...
    wget -nv http://daily.software.cambricon.com/daily/triton/wheel/python3.10/master/${GENESIS_TAG}/triton-${TRITON_VERSION}+mlu${GENESIS_TAG}-cp310-cp310-manylinux2014_x86_64.whl
    pip install triton-${TRITON_VERSION}+mlu${GENESIS_TAG}-cp310-cp310-manylinux2014_x86_64.whl
    rm triton-${TRITON_VERSION}+mlu${GENESIS_TAG}-cp310-cp310-manylinux2014_x86_64.whl
fi
